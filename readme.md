...
| [API key check to authenticate an application - 10k RPS](scenarios/2-api-key/test.js)<br />1. 200 RPS during 10 seconds<br />2. Ramp up to 10k RPS over 3 minutes<br />3. Maintain 10k RPS over 30 seconds<br />4. Ramp down to 200 RPS over 30 seconds | 10.3k RPS |   67.1 ms   | ![backend-only-30k-rps](assets/images/grafana/apikey-10k-rps.png) |
|                                                              |           |             |                                                              |
|                                                              |           |             |                                                              |
